...
const dummyArticles = Array.from({ length: 14 }, (_, i) => ({
  ...
  date: `${i + 1} Nov 2023`, image: articleImages[i % articleImages.length],
  fullContent: [
...
function ViewArtikel({ changeView }) {
  ...
  const currentArticles = dummyArticles.slice((currentPage - 1) * itemsPerPage, currentPage * itemsPerPage);
            ...
            <div className="p-6 flex-grow flex flex-col">
              <div className="flex items-center justify-between text-sm text-slate-500 mb-4">
                <div className="flex items-center space-x-2">
                  <img src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?auto=format&fit=facearea&facepad=2&w=100&h=100&q=80" alt="Admin" className="w-7 h-7 rounded-full object-cover border border-slate-200" />
